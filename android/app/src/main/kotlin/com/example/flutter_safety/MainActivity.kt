...
import kal.fit.bstu.accelerometrhash.AccelerometerHash
            ...
            .setMethodCallHandler { call: MethodCall, result: MethodChannel.Result ->
                if (call.method == "getAccelerometerData") {
                    if (accelerometerHash.isDataSizeReached()) {
                        ...
                        Logger.getLogger(MainActivity::class.java.name).info("Data not ready. Less than 300 values recorded.")
                        result.error("DATA_NOT_READY", "Data not ready. Less than 300 values recorded.", null)
                    }
                } else {
